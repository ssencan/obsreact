...
export default function OgretmenlerComponent() {
  ...
  function initialize(): EffectCallback {
    return () => {
      axiosconfig.get("ogretmen/getall").then((response) => {
  ...
  function btnSilClick(id: number): MouseEventHandler<HTMLButtonElement> {
    return () => {
      ...
      axiosconfig.delete(url).then(initialize());
    };
  }
                ...
                return (
                  ...
                  <tr key={index}>
                    ...
                    <td className="col-auto">
                      {ogretmen.is_GICIK ? "Gıcık" : "Normal"}
                    </td>
                    <td className="col-auto">
                      <NavLink
                        className="btn btn-outline-success"
                        to={"/ogretmen/guncelle?ogrId=" + ogretmen.id}
                      >
                        Güncelle
                      </NavLink>
                    </td>
                    <td className="col-auto">
                      <Button
                        ...
                        onClick={btnSilClick(ogretmen.id)}
                      >
                        Sil
                      </Button>
                    </td>
                    <td className="col-auto">
                      <NavLink
                        ...
                        to={"/ogretmen/detay?ogrId=" + ogretmen.id}
                      >
                        Detay
                      </NavLink>
                    </td>
