...
import OgrenciKaydetComponent from "./components/ogrenci/OgrenciKaydetComponent";
import OgrenciGuncelleComponent from "./components/ogrenci/OgrenciGuncelleComponent";
        ...
        <Row>
          ...
          <Col xs="10">
            <Routes>
              ...
              <Route
                path="ogretmen/detay"
                element={<OgretmenDetayComponent />}
              />
              ...
              <Route
                path="ogretmen/kaydet"
                element={<OgretmenKaydetComponent />}
              />
              <Route
                path="ogretmen/guncelle"
                element={<OgretmenGuncelleComponent />}
              />
              <Route path="ders/kaydet" element={<DersKaydetComponent />} />
              <Route path="ders/guncelle" element={<DersGuncelleComponent />} />
              <Route
                path="ogrenci/kaydet"
                element={<OgrenciKaydetComponent />}
              />
              <Route
                path="ogrenci/guncelle"
                element={<OgrenciGuncelleComponent />}
              />
